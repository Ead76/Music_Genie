...
from music_app.views import LandingPageView,ArtistListView,ArtistCreateView,ArtistUpdateView, SongCreateView, SongListView, SongUpdateView,deleteArtist, deleteSong
ArtistUpdateView,deleteArtist,SongCreateView,SongListView,
urlpatterns = [
